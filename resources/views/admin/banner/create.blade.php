                                ...
                                <div class="row g-3">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <input type="text" name="heading" class="form-control"
                                                    placeholder="@lang('Enter') @lang('Heading')" required autofocus
                                                    autocomplete="one-time-code" value="{{ old('chapter_name_arabic') }}">
                                                @if ($errors->has('chapter_name_arabic'))
                                                    <p style="color:red;font-size: 15px;">
                                                        {{ $errors->first('chapter_name_arabic') }}
                                                    </p>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        <div>
                                            ...
                                            <textarea name="description" class="form-control" style="height:200px;" placeholder="@lang('Enter Description')"></textarea>
