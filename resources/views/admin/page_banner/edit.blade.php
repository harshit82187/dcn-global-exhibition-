    ...
    <div class="page-content">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body">
                            <form action="{{ route('page_banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            @if($banner->banner_img)
                <img src="{{ asset('/public/uploads/page_banners/' . $banner->banner_img) }}" width="200" class="mb-2">
            @else
        ...
        <a href="{{ route('page_banner.index') }}" class="btn btn-secondary">Back</a>
    </form>                        </div>
                    </div>
                </div>
            </div>
