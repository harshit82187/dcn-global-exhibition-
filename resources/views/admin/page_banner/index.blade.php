                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($banner->banner_img)
                                                    <img src="{{ asset('/public/uploads/page_banners/' . $banner->banner_img) }}" width="100">
                                                @endif
                                            </td>
                                            <td>
                                                <a href="{{ route('page_banner.edit', $banner->id) }}" class="btn btn-primary">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
    ...
    <script>
        ...
        function updateModal() {
            ...
            document.getElementById('bannerImage').src = banner.banner_img 
                ? `/dcnglobal/public/uploads/page_banners/${banner.banner_img}` 
                : '';
